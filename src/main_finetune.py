...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--data_csv", type=str, default="data/cluster_updated.csv")
    ...
    arg_parser.add_argument("--npz_folder", type=str, default="npz/npz_R2")
    arg_parser.add_argument("--reagent_option", type=bool, default=False)
    arg_parser.add_argument("--y_column", type=str, default="New_R2")
    arg_parser.add_argument("--train_test_split", type=bool, default=True)
    arg_parser.add_argument("--split_column", type=str, default="Split_R2")
