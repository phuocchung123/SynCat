...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--Data_folder", type=str, default="../Data/data/")
    arg_parser.add_argument("--data_csv", type=str, default="schneider50k.csv")
    ...
    arg_parser.add_argument("--npz_folder", type=str, default="npz/npz_KGG")
