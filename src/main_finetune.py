...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--data_csv", type=str, default="data/USPTO_50k_updated.csv")
    ...
    arg_parser.add_argument("--npz_folder", type=str, default="npz/npz_50k")
    arg_parser.add_argument("--reagent_option", type=bool, default=False)
    arg_parser.add_argument("--y_column", type=str, default="new_class")
