...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        "--data_csv", type=str, default="raw/forward_reactions_dataset_rxn_split.csv.gz"
    )
    arg_parser.add_argument("--model_path", type=str, default="../Data/model/")
    arg_parser.add_argument("--model_name", type=str, default="model_regression_Hieu_forward_sep.pt")
    arg_parser.add_argument("--npz_folder", type=str, default="npz/npz_Hieu_forward_sep")
    arg_parser.add_argument("--y_column", type=str, default="adj_fwd")
