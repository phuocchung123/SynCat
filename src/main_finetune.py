...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        "--data_csv", type=str, default="raw/clustered_data_with_Ea_splitted_dropna_canonicalized_2.csv.gz"
    )
    arg_parser.add_argument("--model_path", type=str, default="../Data/model/")
    arg_parser.add_argument("--model_name", type=str, default="model_regression.pt")
    arg_parser.add_argument("--npz_folder", type=str, default="npz/npz_Hieu_fwd_log")
    arg_parser.add_argument("--y_column", type=str, default="y_fwd")
